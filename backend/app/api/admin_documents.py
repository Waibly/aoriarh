...
async def list_common_document_groups(
    ...
    source_labels = {
        ...
        "arret_cour_appel": "Jurisprudence — Cour d'appel",
        "arret_conseil_etat": "Jurisprudence — Conseil d'État",
        "decision_conseil_constitutionnel": "Jurisprudence — Conseil constitutionnel",
        "convention_collective_nationale": "Conventions collectives",
        ...
        "code_action_sociale": "Code de l'action sociale et des familles (législatif)",
